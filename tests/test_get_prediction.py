...
async def test_get_prediction_creates_user_and_new_prediction(
    ...
    mock_prediction_service.get_prediction_for_user.assert_awaited_once_with(fake_user.id)
    mock_prediction_service.save_prediction_in_db.assert_awaited_once_with(fake_prediction_text, fake_user.id)
