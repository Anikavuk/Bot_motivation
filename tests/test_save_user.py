...
@pytest.mark.asyncio
async def test_save_user_creates_new_user(mock_user_service, mock_prediction_service):
...
@pytest.mark.asyncio
async def test_save_user_sets_cookie(mock_user_service, mock_prediction_service):
